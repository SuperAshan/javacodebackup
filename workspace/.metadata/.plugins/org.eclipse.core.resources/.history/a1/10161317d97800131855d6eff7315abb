...
public class Friendships extends Weibo
{
     ...
     * @since JDK 1.5
     */
    public UserWapper getFriendsByID(String id,int count,int cursor) throws WeiboException
    {
     ...
     * @since JDK 1.5
     */
    public UserWapper getFriendsByScreenName(String screen_name, int count, int cursor)
	    throws WeiboException
    {
	return User.constructWapperUsers(client.get(
		WeiboConfig.getValue("baseURL") + "friendships/friends.json",
		new PostParameter[] { 
		    new PostParameter("screen_name",
			screen_name),
			  new PostParameter("count", count),
			    new PostParameter("cursor", cursor)}));
    }
     ...
     * @since JDK 1.5
     */
    public UserWapper getFriendsInCommon(String uid, int count, int cursor) throws WeiboException
    {
	return User.constructWapperUsers(client.get(
		WeiboConfig.getValue("baseURL")
			+ "friendships/friends/in_common.json",
		new PostParameter[] { new PostParameter("uid", uid) ,  new PostParameter("count", count),
		    new PostParameter("cursor", cursor)}));
    }
     ...
     * @since JDK 1.5
     */
    public UserWapper getFriendsBilateral(String uid, int count, int cursor) throws WeiboException
    {
	return User.constructWapperUsers(client.get(
		WeiboConfig.getValue("baseURL")
     ...
     * @since JDK 1.5
     */
    public UserWapper getFriendsBilateral(String uid, Integer sort, Paging page, int count, int cursor)
	    throws WeiboException
    {
	return User.constructWapperUsers(client.get(
		WeiboConfig.getValue("baseURL")
			+ "friendships/friends/bilateral.json",
		new PostParameter[] { new PostParameter("uid", uid),
			new PostParameter("sort", sort.toString()) ,  new PostParameter("count", count),
			    new PostParameter("cursor", cursor)}, page));
    }
     ...
     * @since JDK 1.5
     */
    public String[] getFriendsBilateralIds(String uid, int count, int cursor) throws WeiboException
    {
     ...
     * @since JDK 1.5
     */
    public String[] getFriendsBilateralIds(String uid, Integer sort, Paging page, int count, int cursor)
	    throws WeiboException
    {
	return User.constructIds(client.get(WeiboConfig.getValue("baseURL")
		+ "friendships/friends/bilateral/ids.json",
     ...
     * @since JDK 1.5
     */
    public String[] getFriendsIdsByUid(String uid, int count, int cursor) throws WeiboException
    {
	return User.constructIds(client.get(WeiboConfig.getValue("baseURL")
     ...
     * @since JDK 1.5
     */
    public String[] getFriendsIdsByName(String screen_name, int count, int cursor)
	    throws WeiboException
    {
	return User.constructIds(client.get(WeiboConfig.getValue("baseURL")
		+ "friendships/friends/ids.json",
		new PostParameter[] { new PostParameter("screen_name",
			screen_name),  new PostParameter("count", count),
			    new PostParameter("cursor", cursor) }));
    }
     ...
     * @since JDK 1.5
     */
    public UserWapper getFollowersByName(String screen_name, int count,int cursor)
	    throws WeiboException
    {
	return User.constructWapperUsers(client.get(
     ...
     * @since JDK 1.5
     */
    public String[] getFollowersIdsById(String uid, int count, int cursor) throws WeiboException
    {
	return User.constructIds(client.get(WeiboConfig.getValue("baseURL")
		+ "friendships/followers/ids.json",
		new PostParameter[] { new PostParameter("uid", uid) ,  new PostParameter("count", count),
	    new PostParameter("cursor", cursor)}));
 //   	System.out.println(client.get(WeiboConfig.getValue("baseURL"));
    }
     ...
     * @since JDK 1.5
     */
    public String[] getFollowersIdsByName(String screen_name, int count, int cursor)
	    throws WeiboException
    {
	return User.constructIds(client.get(WeiboConfig.getValue("baseURL")
		+ "friendships/followers/ids.json",
